  ...
  return (
    <div className="min-h-screen w-full flex bg-surface">
      <div className="hidden lg:flex lg:w-1/2 relative bg-gray-900 overflow-hidden">
        <img src="/hotel-pool.png" alt="Hotel Pool" className="absolute inset-0 h-full w-full object-cover opacity-80" />
        <div className="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/40 to-transparent" />
        <div className="absolute bottom-12 left-12 right-12 text-white">
          <h2 className="text-4xl font-extrabold mb-4 drop-shadow-lg">Junte-se ao SERRÔ.</h2>
          <p className="text-lg text-gray-200 font-medium drop-shadow-md max-w-lg">Crie sua conta para acumular pontos de fidelidade, agilizar suas reservas e ter acesso a benefícios exclusivos.</p>
        </div>
      </div>
          ...
          <div className="text-center mb-10">
            <Link to="/" className="inline-block">
              <motion.div
                ...
                className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-primary-500 to-primary-700 text-white shadow-xl shadow-primary-500/20 hover:scale-105 transition-transform"
              >
                <UserPlus className="h-8 w-8" />
              </motion.div>
            </Link>
            <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Criar Conta</h1>
            <p className="text-gray-500 mt-2 text-lg">Faça seu cadastro de hóspede</p>
          </div>

          <div className="bg-white p-8 sm:p-10 rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100">
            <div className="flex items-center justify-center gap-6 mb-10">
              {[
                { title: 'Pessoais', description: 'Básico' },
                ...
                <div key={i} className="flex items-center gap-3">
                  <div className={`
                    ...
                    ${i < step ? 'bg-green-500 text-white' : i === step ? 'bg-primary-600 text-white shadow-lg shadow-primary-600/30' : 'bg-gray-100 text-gray-400'}
                  `}>
            ...
            <div className="mt-10 flex gap-4">
              ...
              {step < 1 ? (
                <Button onClick={nextStep} className="flex-1 h-12 rounded-xl text-lg">
                  Próximo Passo
                  <ChevronRight className="h-5 w-5" />
                </Button>
              ) : (
                <Button onClick={handleSubmit} isLoading={isLoading} className="flex-1 h-12 rounded-xl text-lg">

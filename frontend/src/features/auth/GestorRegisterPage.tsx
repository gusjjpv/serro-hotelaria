        ...
        <Card variant="glass">
          <div className="text-center mb-8">
            <motion.div
              ...
              className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-gold-500 to-gold-700 text-white shadow-xl shadow-gold-500/20"
            >
              <Shield className="h-8 w-8" />
            </motion.div>
            <h1 className="text-2xl font-bold text-gray-900">Cadastro Gestor</h1>
            <p className="text-muted mt-1">Cadastre-se como gestor do SERRÔ</p>
          </div>
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-2">
                <div className={`
                  ...
                  ${i < step ? 'bg-green-500 text-white' : i === step ? 'bg-gold-600 text-white shadow-lg shadow-gold-600/20' : 'bg-gray-100 text-gray-400'}
                `}>

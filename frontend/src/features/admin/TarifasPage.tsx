          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-gray-50/80 border-b border-gray-100">
                ...
                <th className="px-6 py-5 text-xs font-bold text-gray-500 uppercase tracking-wider">Diária</th>
                <th className="px-6 py-5 text-xs font-bold text-gray-500 uppercase tracking-wider">Período</th>
                <th className="px-6 py-5 text-xs font-bold text-gray-500 uppercase tracking-wider">Temporada</th>
